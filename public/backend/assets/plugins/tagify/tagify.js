...
!(function (t, e) {
    ...
    var m = {
        ...
        show(t) {
            ...
            if (
                ...
                if (
                    ...
                    (i =
                        "" +
                        (l((e = this.suggestedListItems[0])) ? e.value : e)),
                        n.autoComplete &&
                            i &&
                            0 == i.indexOf(t) &&
                        ...
                        case "Enter":
                            t.preventDefault(),
                                this.settings.hooks
                                    ...
                                    .then(() => {
                                        if (e)
                                            return this.dropdown.selectOption(
                                                e
                                            );
                                        this.dropdown.hide(),
                                            "mix" != this.settings.mode &&
        ...
        selectOption(t) {
            ...
            if (!t)
                return (
                    (e = this.addTags(this.state.inputText, !0)),
                    void (a && this.dropdown.hide())
                );
            var n = t.getAttribute("tagifySuggestionIdx"),
                o = this.suggestedListItems[+n];
            this.trigger("dropdown:select", { data: o, elm: t }),
                n && o
                    ? (this.state.editing
                          ? this.onEditTagDone(
                                null,
                                d({ __isValid: !0 }, this.normalizeTags(o)[0])
                            )
                          : (e = this[
                                "mix" == this.settings.mode
                                    ? "addMixTags"
        ...
        filterListItems(t, e) {
            ...
            if (!t || !m.length)
                return (
                    r.duplicates
                        ? p
                        : p.filter(
                              (t) => !this.isTagDuplicate(l(t) ? t.value : t)
                          )
                ).slice(0, u);
            function f(t, e) {
                return e
            ...
            for (
                ...
                let T = !Object.keys(i).some((t) => m.includes(t))
                    ? ["value"]
                    : m;
                d.fuzzySearch && !e.exact
                    ...
                    (n =
                        !r.duplicates &&
                        this.isTagDuplicate(l(i) ? i.value : i)),
                    s &&
                        !n &&
                        (u && t
                            ? c.push(i)
        ...
        createListHTML(t) {
            return d([], t)
                .map((t, e) => {
                    ...
                    var s = this.settings.templates.dropdownItem.apply(this, [
                        t,
                        this,
                    ]);
                    return (s = s
        ...
        callbacks: {
            ...
            onKeydown(t) {
                ...
                switch (t.key) {
                    ...
                    case "ArrowRight": {
                        let t =
                            this.state.inputSuggestion || this.state.ddItemData;
        ...
        return t
            ? t.previousElementSibling &&
              t.previousElementSibling.classList.contains("tagify")
                ? (console.warn(
                      "Tagify: ",
                      "input element is already Tagified",
                      t
                  ),
                  this)
                : (d(
        ...
        (y.prototype = {
            ...
            applySettings(t, i) {
                ...
                (s.disabled = t.hasAttribute("disabled")),
                    (s.readonly = t.hasAttribute("readonly")),
                    (s.placeholder =
                ...
                if (
                    ...
                    ["whitelist", "blacklist"].forEach((e) => {
                        ...
                        i &&
                            (i = i.split(s.delimiters)) instanceof Array &&
                            (s[e] = i);
                    }),
                    "autoComplete" in i &&
                        !l(i.autoComplete) &&
            ...
            loadOriginalValues(t) {
                ...
                if ((this.removeAllTags({ withoutChangeEvent: !0 }), t))
                    if ("mix" == i.mode)
                ...
                if (a) {
                    if (!(o instanceof Object && "editable" in o) || o.editable)
                        return (
                            ...
                            e.skipValidation ||
                                (h = this.editTagToggleValidity(t)),
                            (a.originalIsValid = h),
                ...
                this.trigger("edit:beforeUpdate", i, { cloneData: !1 }),
                    ...
                    t && e[this.settings.tagTextProp]
                        ? ((t = this.replaceTag(t, e)),
                          ...
                          this.settings.a11y.focusableTags && t.focus())
                        : t && this.removeTags(t),
                ...
                return (t[i] + "").trim()
                    ? e.pattern &&
                      ...
                      !e.pattern.test(s)
                        ? this.TEXTS.pattern
                        : !e.duplicates &&
                          this.isTagDuplicate(s, this.state.editing)
                        ...
                        n.childNodes.forEach((n) => {
                            if (1 == n.nodeType) {
                                ...
                                if (
                                    ...
                                    t +=
                                        i[0] +
                                        JSON.stringify(a(o, e.dataProps)) +
                                        i[1];
                                }
